...
function VolumeControl({ isMobile }) {
  ...
  return (
    <div className={isMobile ? 'volume-control-mobile2' : 'volume-control2'}>
      <button id={isMobile ? 'muteVol-mobile' : 'muteVol'} onClick={toggleMute}>
